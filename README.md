...
이번 프로젝트를 통해 운영체제의 CPU 관리(스케줄링), 메모리 관리(페이징), 파일 시스템을 살펴보고, 각각에 새로운 구성요소를 추가해 볼 것이다.
...
3. [xv6의 스케줄러 수정하기](https://github.com/simjeehoon/xv6-public/tree/os/prj3)
4. [페이징 알고리즘 시뮬레이션](https://github.com/simjeehoon/page-simulator)
5. [xv6에 새로운 파일 시스템 추가하기](https://github.com/simjeehoon/xv6-public/tree/os/prj5)
